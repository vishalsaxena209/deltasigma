%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% A fourth-order DSM with CIFF Architecture with
% all zeros at DC.
...
OSR = 16;   % OSR
opt = 0;    % Don't optimize the zeros
...
form = 'CIFF';  % CIFB modulator structure

%% Find the coefficients a,g,b,c. 
[a,g,b,c] = realizeNTF(H, form);

% Let the toolbox decide the feed-in coefficients b's
% b(2:end) = 0;
